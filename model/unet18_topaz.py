...
if __name__ == "__main__":
	...
	learn.save(f'/group/pawsey0149/mmckay/singularity/unet_results/unet18/unet18fold{args.val_fold}_modelweights', with_opt=True, pickle_protocol=2)
	
	learn.export(fname=f'/group/pawsey0149/mmckay/singularity/unet_results/unet18/unet18fold{args.val_fold}_modelweights_exported.pkl',
                pickle_module=pickle,
		pickle_protocol=2)

	imtest = glob.glob("/group/pawsey0149/mmckay/singularity/holdout_set/images/*")
	export_predictions(imtest, f"/group/pawsey0149/mmckay/singularity/unet_results/unet18/unet18_preds/unet18fold{args.val_fold}_predictions")
